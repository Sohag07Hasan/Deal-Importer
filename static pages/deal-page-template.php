...
<?php
	 ...
	 */
	echo '<tr><th>Address</th><th>Square Feet</th><th>Tenant</th><th>Representative</th><th>Landlord</th><th>Landlord Representitive</th><th>Notes</th><th>Issues</th><th>Date</th></tr>';
	while ( $wp_query->have_posts() ) : $wp_query->the_post();
		...
		echo '</tr>';
	endwhile;
	remove_filter('posts_join', 'trdm_get_custom_field_posts_join');
	remove_filter('posts_groupby', 'trdm_get_custom_field_posts_group');
		echo '</tr></table>';
		echo '</div>';
		if($_REQUEST['deal_search'] != 'Y') : 
